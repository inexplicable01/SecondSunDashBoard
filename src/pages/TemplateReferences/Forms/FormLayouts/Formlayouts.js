...
const Formlayouts = () => {
    document.title="Form Layouts | Second Sun Node Device Dashboard";
    return (
        <React.Fragment>
            <UiContent />
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="live-preview">
                                        <form action="TemplateReferences/Forms/FormLayouts#" className="row g-3">
                                            <Col md={12}>
                        ...
                        <Col xxl={6}>
                            <Card >
                                ...
                                <p className="text-muted">Example of vertical form using <code>form-control</code> class. No need to specify row and col class to create vertical form.</p>
                                    <div className="live-preview">
                                        <Form action="TemplateReferences/Forms/FormLayouts#">
                                            <div className="mb-3">
