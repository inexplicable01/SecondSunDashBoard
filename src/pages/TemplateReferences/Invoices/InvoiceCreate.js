...
import { addNewInvoice as onAddNewInvoice, updateInvoice as onUpdateInvoice } from "../../../store/TemplateReferences/invoice/action";
...
const InvoiceCreate = () => {
  ...
  document.title = "Create Invoice | Second Sun Node Device Dashboard";
